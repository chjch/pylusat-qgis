...
class PointDistance(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterVectorDestination(
                self.OUTPUT, self.tr("Output shapefile")
            )
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        point_lyr = self.parameterAsVectorLayer(
            parameters, self.POINT, context
        )
        method = self.method[
        ...
        output_shp = self.parameterAsOutputLayer(
        ...
        input_gdf[output_clm] = distance.to_point(
            input_gdf, point_gdf, method, data_type
        )
